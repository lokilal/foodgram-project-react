...
from reviews.models import Recipe, Tag, Ingredient, NumberOfIngredients, Favorites, Purchase
...
class IngredientForRecipeCreate(IngredientForRecipeSerializer):
    ...
    def to_representation(self, instance):
        ingredient_in_recipe = [
            item for item in
            NumberOfIngredients.objects.filter(ingredient=instance)
        ]
...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for ingredient in ingredients:
            ...
            NumberOfIngredients.objects.create(recipe=recipe,
    ...
    def update(self, instance, validated_data):
        ...
        for item in ingredients_data:
            ...
            if NumberOfIngredients.objects.filter(
                    id=ingredient_id, amount=amount
            ).exists():
                ingredients_instance.remove(
                    NumberOfIngredients.objects.get(id=ingredient_id,
                                                    amount=amount
                                                    ).ingredient)
            else:
                NumberOfIngredients.objects.get_or_create(
                    recipe=instance,

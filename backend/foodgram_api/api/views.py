...
from reviews.models import Recipe, Tag, Favorites, Purchase, Ingredient, NumberOfIngredients
from .serializers import RecipeSerializer, RecipeReadSerializer, TagSerializer, FavoriteSerializer, IngredientSerializer
...
def download_shopping_cart(request):
    ...
    for item in cart:
        recipe = item.recipe
        ingredients_in_recipe = NumberOfIngredients.objects.filter(
            recipe=recipe
        )
